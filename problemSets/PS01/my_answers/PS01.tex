...
\lstinputlisting[language=R, firstline=43, lastline=43]{PS01.R}  
...
\begin{enumerate}
	\item Find a 90\% confidence interval for the average student IQ in the school.\\
		...
		\lstinputlisting[language=R, firstline=60, lastline=61]{PS01.R}  
		
		This returned a mean of 98.44
		
		Then, I found the standard deviation:
		
		\lstinputlisting[language=R, firstline=65, lastline=65]{PS01.R}
		...
		\lstinputlisting[language=R, firstline=77, lastline=77]{PS01.R}  
		
		And the lower bounds of confidence interval
		\lstinputlisting[language=R, firstline=81, lastline=81]{PS01.R} 
	...
	\noindent Using the same sample, conduct the appropriate hypothesis test with $\alpha=0.05$.
		...
		\lstinputlisting[language=R, firstline=94, lastline=94]{PS01.R} 
	...
	\end{center}
		...
		\normalsize In R:
		\lstinputlisting[language=R, firstline=104, lastline=107]{PS01.R}
		...
		\lstinputlisting[language=R, firstline=114, lastline=114]{PS01.R}
...
\vspace{.5cm}
\lstinputlisting[language=R, firstline=131, lastline=131]{PS01.R}  
\vspace{.5cm}
\begin{itemize}
...
I thought the best way to show this relationship was using a box plot. The red dots show the mean per capita expenditure on shelters/housing assistance in each region.
...
\lstinputlisting[language=R, firstline=190, lastline=193]{PS01.R}
I used the code we learnt in coding camp for this.

Then, I found their respective means:
\lstinputlisting[language=R, firstline=196, lastline=199]{PS01.R}

I used this in my script to plot the box plot:
\lstinputlisting[language=R, firstline=208, lastline=215]{PS01.R}
...
\lstinputlisting[language=R, firstline=222, lastline=223]{PS01.R}

Plotting the same graph while grouping the results according to region.

\lstinputlisting[language=R, firstline=228, lastline=233]{PS01.R} 
